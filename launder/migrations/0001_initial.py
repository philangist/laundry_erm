...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'launder_washfoldorder', (
            ...
            ('daily_operations', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2013, 8, 13, 0, 0), to=orm['launder.DailyOperations'])),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 13, 0, 0))),
            ...
            ('payment_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 13, 0, 0))),
    ...
    models = {
        u'launder.dailyoperations': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'launder.drycleaning': {
            'Meta': {'object_name': 'DryCleaning'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'daily_operations': ('django.db.models.fields.related.ForeignKey', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)', 'to': u"orm['launder.DailyOperations']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
            ...
            'payment_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
